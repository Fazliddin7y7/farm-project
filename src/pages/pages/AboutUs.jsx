...
// Qolgan komponentlarni oldingi kabi qoldiraman...
// (TimelineSection, TestimonialsSection va boshqa barcha komponentlar oldingi kodda bor)

export default function AboutUs() {
  // ... oldingi kodning return qismini o'zgartiraman
  return (
    <>
      <Header />
      <AboutCtn>
        {/* Boshidagi banner qismi */}
        <Banner>
          <img src={BackgroundImage} alt="About Us Banner" />
          <BannerOverlay>
        ...
        <CurrentlyCtn>
          ...
          <div className="info-boxes">
            ...
            <div className="info-item">
              <img src={EcoIcon} alt="Eco Farms Worldwide" className="icon" />
            ...
            <div className="info-item">
              <img src={TruckIcon} alt="Special Equipment" className="icon" />
              <div className="text-box">
        ...
        <SectionsWrapper>
          ...
          <TitleSection>Best Agriculture Services</TitleSection>
          ...
          {/* ... qolgan sectionlarni shu joyga qo'shing ... */}
        </SectionsWrapper>
      </AboutCtn>
      <Footer />
    </>
